 ...
 */
class AdminLogs extends \backend\models\BaseModel
{
    use AdminLogsTrait;
    ...
    public function rules()
    {
        return [
            [['log_id'], 'required'],
            [['request_data','module_name', 'menu_name'], 'string'],
            [['create_date'], 'safe'],
            [['priv_name', 'create_user'], 'string', 'max' => 50],
...
//                         'dbType' => "text",
                        ...
                        'type' => 'text',
                        'unsigned' => false,
                        'label'=>$this->getAttributeLabel('request_data'),
                        'inputType' => 'text',
                        'isEdit' => true,
                        'isSearch' => false,
                        'isDisplay' => true,

 ...
 */
class AdminMenus extends \backend\models\BaseModel
{
    use AdminMenusTrait;
    ...
    {
        return [
            [['menu_id','menu_name','priv_url','display_order'], 'required'],
			[['priv_url','menu_name'], 'unique'],
            [['menu_id', 'module_id', 'display_order', 'status'], 'integer'],
            [['create_date', 'update_date'], 'safe'],
            [['menu_name', 'create_user', 'update_user'], 'string', 'max' => 50],

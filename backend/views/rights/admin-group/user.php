...
<script>
    var RELATION_GROUP_USER   = "<?=Url::toRoute('rights/admin-group/relation')?>";
    var RELEASE_GROUP_USER = "<?=Url::toRoute('rights/admin-group/release')?>";
</script>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php ActiveForm::begin(['id' => 'admin-user-group-search-form', 'method' => 'get', 'options' => ['class' => 'form-inline'], 'action' => Url::toRoute('rights/admin-group/user')]); ?>
                                ...
                                <?php
                                if (CommonFun::hasPriv('rights/admin-group/relation') ) {
                            ...
                            <div class="col-sm-12">
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="data_table_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        ?>
                                        <th tabindex="0" style="width:100px;" aria-controls="data_table" rowspan="1" colspan="1"

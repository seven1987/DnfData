...
$system_rights = $this->context->system_rights;
...
<!--            <div class="user-panel">
                <div class="pull-left image">
                    <span  class="admin-big-icon" ><img src="/dist/img/admin-common/admin-user.png"/></span>
                </div>

                <div class="pull-left info user-info">
                    <p><?php /*echo Yii::$app->user->identity->uname; */?></p>
                    <a href="<?/*= Url::toRoute('site/logout') */?>"><i class="img-logout"></i><span class="logout-text">退出</span></a>
                </div>
            </div>-->
...
<!--      </div>-->
            ...
            <ul class="sidebar-menu">
                ...
                foreach ($system_menus as $key=>$menu) {
                    ...
                    $menuHtml .= '   <a href="#"  >';
                    $menuHtml .= '   <i class="  '.$moudle.'-'.$key.'"></i> <span>' . $menu['label'] . '</span>';
                    ...
                    if ($isTreeView != "") {
                        ...
                        foreach ($funcList as $fun) {
                            ...
                            $menuHtml .= '<li ' . $isActive . '><a href="' . Url::to([$fun['url']]) . '">' . $fun['label'] . '</a></li>';
...
<!--        </div>-->
<!--        <strong>Copyright &copy; 2015---><?//= date('Y') ?><!-- <a-->
<!--                    href="--><?//= Yii::$app->params['homePage'] ?><!--">--><?//= Yii::$app->params['appName'] ?><!--</a>.</strong> All rights-->
<!--        reserved.-->
<!--    </footer>-->

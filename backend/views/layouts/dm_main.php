...
<head>
  ...
  <meta name="csrf-token" content="<?= Yii::$app->getRequest()->getCsrfToken();?>">
  ...
  <script src="<?= Url::base() ?>/dist/res/<?= strtolower(Yii::$app->language)?>/syscode.js"></script>
...
<div class="modal fade" id="confirm_dialog" tabindex="-1" role="dialog" style="z-index: 10000;"

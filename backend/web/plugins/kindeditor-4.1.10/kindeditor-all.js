...
function _mediaEmbed(attrs) {
    var html = '<embed allowscriptaccess="always" allownetworking="all" quality="high" bgcolor="#000" wmode="window" allowfullscreen="true" allowFullScreenInteractive="true" ';
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;color:#ffffff}',
